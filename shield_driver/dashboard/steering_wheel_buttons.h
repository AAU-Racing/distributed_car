...
#define SW_BUTTON1_GPIO_PORT              GPIOA

#define SW_BUTTON2_PIN                    PIN_7
#define SW_BUTTON2_GPIO_PORT              GPIOA

#define SW_BUTTON3_PIN                    PIN_8
#define SW_BUTTON3_GPIO_PORT              GPIOA

#define SW_BUTTON4_PIN                    PIN_9
#define SW_BUTTON4_GPIO_PORT              GPIOA

#define SW_BUTTON5_PIN                    PIN_10
#define SW_BUTTON5_GPIO_PORT              GPIOA

#define SW_BUTTON6_PIN                    PIN_11
#define SW_BUTTON6_GPIO_PORT              GPIOA

#define SW_BUTTON7_PIN                    PIN_12
#define SW_BUTTON7_GPIO_PORT              GPIOA

#define SW_BUTTON8_PIN                    PIN_13
#define SW_BUTTON8_GPIO_PORT              GPIOA
